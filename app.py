...
st.markdown("""
    ...
    .table-row { background-color: #1E1E24;padding: 8px; border-bottom: 1px solid rgba(255, 255, 255, 0.1); align-items: center; text-align: center; font-size: 14px;border-radius: 4px; }
    </style>
